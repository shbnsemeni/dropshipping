...
export default function NewProductPage() {
  ...
  return (
    <div className="max-w-2xl">
      <h1 className="text-2xl font-bold text-stone-900 mb-6">New Product</h1>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <Input label="AliExpress URL" name="aliExpressUrl" value={form.aliExpressUrl} onChange={handleChange} placeholder="https://www.aliexpress.com/item/..." />
